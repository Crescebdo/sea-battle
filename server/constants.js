    ...
    skills: [
      {
        skillName: "闪避",
        description:
          "每场游戏限一次，被攻击后，若未抵挡，可以消耗50节操，闪避本回合所有攻击。",
      },
    ],
    passive: "被冰雹击中的概率为25%。",
    ...
    skills: [
      {
        skillName: "反击",
        description:
          "每个普通回合限一次，被攻击后，你获知伤害来源所处方向，然后在本回合结束后，执行一个攻击额外回合。",
      },
      {
        skillName: "借炮杀人",
        description:
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        skillName: "丢冰块",
        description:
          "每场游戏限一次，普通回合中，可减少1格体积并失去1血，令本回合你的攻击附带眩晕效果。被眩晕的船只无法进行任何操作，直到其下一个普通回合结束。",
      },
    ],
